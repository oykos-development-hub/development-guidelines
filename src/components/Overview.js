        ...
        return (
            <div id="Overview" className="flex-column">
                ...
                <div id="mainPage" className="column align-start">
                    ...
                    <div id="margin-padding" className="row justify-start align-center padding-h-20 margin-t-20">
...
relative values are 5%, 10%, 20%, 25%, 30%, 33%, 48%, 50%, 67%, 70%, 80%, 90%, 100%, 120%, 150%, 200%</p>
                    ...
                    <div id="background" className="row justify-start align-center padding-h-20">
                        ...
                        <div id="right" className="flex wrap justify-start align-center margin-h-10">
                            <div className="flex flex-start margin-t-20 margin-r-10 w-500 h-300 border-1 background-size-100perc" style={{ backgroundImage: `url(${require("../img/court.jpg")})` }}>
                                <p className="bolder">Background size 100%</p>
                            </div>
                            <div className="flex flex-start margin-t-20 margin-r-10 w-500 h-300 border-1 background-size-30perc bg-repeat" style={{ backgroundImage: `url(${require("../img/court.jpg")})` }}>
